...
public class TelldusInterface {
    ...
    public Protocol.DeviceMethod tdLastSentCommand(int deviceId, int methodsSupported) {
        ...
        return Protocol.DeviceMethod.fromCode(client.getIntegerFromService(m));
    }
    ...
    public Protocol.DeviceType tdGetDeviceType(int intDeviceId) {
        ...
        return Protocol.DeviceType.fromCode(client.getIntegerFromService(msg));
    }
    ...
    public Protocol.ErrorCode tdSendRawCommand(String command, int reserved) {
        ...
        return Protocol.ErrorCode.fromCode(client.getIntegerFromService(msg));
    }
